...
export default function UpdateStudent() {
  const [student, setStudent] = useState({ studentName: "", studentAge: "" });
      ...
      .catch((error) => {
        ...
        if (error.response) {
          ...
          if (error.response.status === 401) {
            ...
            console.log(error.response.data.payload.errorReason);
            setIsNotExist(true);
      ...
      .catch((error) => {
        ...
        if (error.response) {
          ...
          if (error.response.status === 400) {
            ...
            setMessageDetail(error.response.data.payload.errorReason);
            setShowMessage(true);
